...
public class Practice extends BaseTest {
	...
	public static void IPBill_Close() throws InterruptedException {
		...
		WebElement FilterALL = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@type='checkbox'])[1]")));
		FilterALL.click();
		Thread.sleep(3000);
		...
		// Add Receipt - Payment by Cash
				...
				WebElement FilterALL1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@type='checkbox'])[1]")));
				FilterALL1.click();
				Thread.sleep(3000);
				
				WebElement FilterUnpaid1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@type='checkbox'])[3]")));
				FilterUnpaid1.click();
				...
				WebElement IPBillsclose = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'IP Bills')]")));
				IPBillsclose.click();
				Thread.sleep(2000);
				...
				WebElement FilterALL2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@type='checkbox'])[1]")));
				FilterALL2.click();
				Thread.sleep(3000);
				
				WebElement FilterUnpaid2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@type='checkbox'])[3]")));
				FilterUnpaid2.click();
				...
				// Extract the amount
				WebElement amountElementClose = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//td)[9]")));
				...
				WebElement Clickbillclose = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Yes')]")));
				...
				WebElement clickbillCloseAgain = wait.until(
						ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Bill Close')]")));
				clickbillCloseAgain.click();
				Thread.sleep(3000);
				
				WebElement Confirmbillclose = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Yes')]")));
				...
				WebElement IPBillscloseStatus = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'IP Bills')]")));
				IPBillscloseStatus.click();
				Thread.sleep(2000);
				
				WebElement searchButton4 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@title='Search']")));
				searchButton4.click();
				
				WebElement SavePatient3 = driver.findElement(By.xpath("//thead/tr[2]/th[1]/input[1]"));
				SavePatient3.sendKeys(columnValue);
				SavePatient3.sendKeys(Keys.ENTER);
				Thread.sleep(2000);
				...
				Reporter.log(columnValue + " : After Paid IP Bill Status : " + columnValueStatusAfter);
				System.out.println(columnValue + " : After Paid IP Bill Status : " + columnValueStatusAfter);
	...
	public static void IPBill_Add_Delete() throws InterruptedException {
		...
		Select ItemTypeLab = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		ItemTypeLab.selectByVisibleText("Lab");
		
		driver.findElement(By.xpath("//span[text()='Select']")).click();
		
		WebElement elementLab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),' BILIRUBIN PACK ')]")));
		elementLab.click();
		
		driver.findElement(By.xpath("//span[contains(text(),'Add New')]")).click();
	
		Select ItemTypeLab1 = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		ItemTypeLab1.selectByVisibleText("Lab");
		
		driver.findElement(By.xpath("//span[text()='Select']")).click();
		
		driver.findElement(By.xpath("//span[contains(text(),' D-Dimer Test ')]")).click();
		
		
		// Add Scan
		driver.findElement(By.xpath("//span[contains(text(),'Add New')]")).click();
		
		Select ItemTypeScan = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		...
		Select ItemTypeScan1 = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		...
		Select ItemTypeService = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		ItemTypeService.selectByVisibleText("Service");
		
		driver.findElement(By.xpath("//span[text()='Select']")).click();
		
		
		driver.findElement(By.xpath("//span[contains(text(),' ECG CHARGES ')]")).click();
		
		driver.findElement(By.xpath("//span[contains(text(),'Add New')]")).click();
	
		Select ItemTypeService1 = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		...
		Select ItemTypeOthers = new Select(driver.findElement(By.xpath("//select[@class='form-control ng-star-inserted ng-untouched ng-pristine ng-valid']")));
		...
		WebElement clickedit = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Edit Bill')]")));	
		clickedit.click();
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//a[contains(text(),'IP Bills')]")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(2000);
				...
				WebElement searchButton3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@title='Search']")));
				searchButton3.click();
